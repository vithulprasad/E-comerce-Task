...
import { register } from '../../../apis/connections/user'
...
function Register() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="flex w-[350px] flex-col justify-center px-6 py-12 lg:px-8 shadow-lg h-[600px] border bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300">
