...
import { isLogIn, order } from "../../apis/connections/user";
...
function CheckOut() {
  ...
  useEffect(() => {
    const totalPrice = location.state.reduce((accumulator, value) => {
  ...
  const handleSubmit = async () => {
    if (state == "") {
      ...
      toast.error("please enter the local area");
    } else {
      await isLogIn().then((res) => {
        if (res.data.success == true) {
          ...
          toast.error("please login for purchase");
        }
      });
    }
  };
    ...
    <div className="w-full max-w-screen-lg mx-auto">
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          ...
          <div className="mt-8 space-y-3 h-[300px] rounded-lg border bg-white px-2 py-4 sm:px-6 overflow-y-scroll no-scrollbar">
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <div className="">
            <label className="mt-4 mb-2 block text-sm font-medium">State</label>
            <div className="relative">
              <input
                onChange={(e) => {
